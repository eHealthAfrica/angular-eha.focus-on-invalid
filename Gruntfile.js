module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      scripts: {
        ...
        rename: function(dest, src) {
          return dest + src.replace('scripts','focus-on-invalid');
        }
      }
    },
    concat: {
    ...
    uglify: {
      dist: {
        files: {
          'dist/focus-on-invalid.template.min.js': ['.tmp/scripts.template.js'],
          'dist/focus-on-invalid.min.js': ['.tmp/scripts.js']
        }
      }
    },
    html2js: {
      dist: {
        ...
        module: 'eha.focus-on-invalid.template',
        options: {
